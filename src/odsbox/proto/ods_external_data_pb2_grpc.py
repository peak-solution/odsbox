...
from odsbox.proto import ods_external_data_pb2 as asam__odsbox_dot_proto_dot_ods__external__data__pb2
...
def add_ExternalDataReaderServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler("ods.external_data.ExternalDataReader", rpc_method_handlers)
